// build this project and session_save_path
// build last php_strip_whitespace
// add contact , all the pages work 
// build the pages out then lock it 
// everytime build out first then lock it down 
// actual final exam at home 
