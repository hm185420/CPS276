...
// build what Scott has "AddContact php" different values to it 
...
$elementsArr = [
  "masterStatus"=>[
    ...
    "errorOutput"=>"",
    "type"=>"text", // so sticky form understands 
    "value"=>"Scott", // what's the value : why Scott signed to it? Value of Scott doing? 
		"regex"=>"name"
	],
	"phone"=>[
