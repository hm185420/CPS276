...
function init()
{
    ...
    if(isset($_POST['submit'])){
        ...
        //$_Post : a list of all the field names and values sent by a form using the post method. data is sent when the request is made to the server for a file, but is not attached to URL.
...
function addData($post){
    ...
    // isset methods: if a variable is set and is not null. clicked then will be sent as $_POST['contacts'
...
function getForm($acknowledgement, $elementsArr)
{
    ...
    global $stickyForm; // sends data to the server through a form that data needs to be sanitized before it can be used. cheked to make sure it si what we are intending. must be done on the server. once a user submits form, lost the data. 
                        // creating "sticky form" remember the data the user sent and if there is an error in the data (the wrong format), the application will display the form data back, 
