...
// a sticky from: a standard HTML form that remembers how you filled it our. 
// particularly nice feature for end users, if you are requiring them to resubmit a form
...
// When using my StickyForm class, you must make sure to write the associative array correctly. 
// current array: "text" "select" "checkbox" "radio" 
// maybe "password" for the Login page?
...
class StickyForm extends Validation {
    ...
    public function validateForm($GlobalPost, $elementsArr){
        ...
        foreach($elementsArr as $k=>$v){
			...
			/*IF THE TYPE IS SELECT THEN IT CHECKS TO MAKE SURE WHAT WAS SELECTED IS STICKY.  IT DOES NOT CHECK ANY VALIDATION ISSUES AS A SELECT BOX TECHNICALLY WILL BE CORRECT. HOWEVER IT COULD BE SET UP TO CHECK FOR CORRECT INPUT */ 
