...
{	
  ...
  public function dbOpen()
  {
    ...
    {
      $dbHost = 'localhost';
      $dbName = 'hmoon3';//this will be your WCC username
      $dbUsr = 'hmoon3';//this will be your WCC username
      $dbPass = 'Gywlsdltkfkd1987!!';//this will be the password found in the video.
